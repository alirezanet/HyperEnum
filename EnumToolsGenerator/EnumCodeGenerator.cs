...
namespace EnumTools
{
    ...
    public class EnumCodeGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            writer.WriteLine("namespace EnumTools");
            writer.WriteLine("{");
            writer.Indent++;
        ...
        {
            writer.WriteLine($"public static string AsString(this {name} member)");
            writer.WriteLine("{");
            writer.Indent++;
        ...
        private static IEnumerable<EnumDeclarationSyntax> GetEnumItems(SyntaxTree syntaxTree)
        {
            return syntaxTree.GetRoot().DescendantNodes().OfType<EnumDeclarationSyntax>()
                .Where(x => x.AttributeLists.Any(q => Regex.IsMatch(q.ToString(), @"\[\s*?EnumTools\s*?\]")));
        }
